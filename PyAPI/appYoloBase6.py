#apenenas para detectar a pplaca recortar e enviar para o OCR
#versão usando based 64 imagem
import sys
import json
import cv2
import os
    ...
    try:
        ...
        for resultado in resultados:
            for box in resultado.boxes:
                ...
                _, buffer = cv2.imencode('.jpg', placa_recortada)
                ...
                return {
                    ...
                    "confianca": confianca,
                    "imagem": imagem_base64,  # ← Imagem em base64
